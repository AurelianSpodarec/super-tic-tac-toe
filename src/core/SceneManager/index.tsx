...
//   if (!ctx) throw new Error("useSceneManager must be used within SceneManagerProvider");
//   return ctx;
// };
...
//   initialScene: string;
//   scenes: Scene[];
//   children?: ReactNode; // optional, for overlays/HUD
// }
...
//   return (
//     <SceneManagerContext.Provider value={{ switchScene, pushScene, popScene, back, currentScene }}>
//       {children}
