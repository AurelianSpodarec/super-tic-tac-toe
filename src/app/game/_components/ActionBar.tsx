...
import useScene from "../_engine/SceneManager/useScene";
import { MenuItem } from "../_engine/FocusNavigator/useFocusNavigator";
import { sceneRegistry } from "../_engine/settings";
import useButtonController from "../_engine/useButtonController";

function ActionBar() {
  const { pop, push, stack } = useScene();
  ...
  const canGoBack =
    stack.length > 1 &&
    !isModalOpen &&
    currentMeta.actionBar?.showBack !== false;
  ...
  const leftButton: MenuItem | null = isModalOpen
    ? { id: "back", text: "Close", action: pop }
    : canGoBack
      ? { id: "back", text: "Back", action: pop }
      : null;
      ...
      <div className="flex gap-2">
        {leftButton ? (
          <button
            ...
            aria-label={isModalOpen ? "Close" : "Go back"}
          >
            <span className="sr-only">{isModalOpen ? "Close" : "Go back"}</span>
        ...
        {showSettings ? (
          <button onClick={() => handleClick("settings")} aria-label="Settings">
            ...
            <svg className="w-6 h-6 fill-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
              <g data-name='setting android app aplication phone'>
                <path d='M30.56 8.47a8 8 0 0 0-7-7 64.3 64.3 0 0 0-15.06 0 8 8 0 0 0-7 7 64.3 64.3 0 0 0 0 15.06 8 8 0 0 0 7 7 64.3 64.3 0 0 0 15.06 0 8 8 0 0 0 7-7 64.3 64.3 0 0 0 0-15.06m-2 14.83a6 6 0 0 1-5.28 5.28 63.7 63.7 0 0 1-14.6 0 6 6 0 0 1-5.26-5.28 63.7 63.7 0 0 1 0-14.6A6 6 0 0 1 8.7 3.42a63.7 63.7 0 0 1 14.6 0 6 6 0 0 1 5.28 5.28 63.7 63.7 0 0 1 0 14.6z'></path>
                <path d='m25.43 15.12-1.56-.3a7 7 0 0 0-.25-1l1.22-1a2 2 0 0 0 .27-2.82l-1.28-1.57A2 2 0 0 0 21 8.17l-1.2 1a7 7 0 0 0-.95-.44V7.14a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2l.06 1.57a9 9 0 0 0-1 .48l-1.26-1a2 2 0 0 0-2.8.37l-1.19 1.78a2 2 0 0 0 .34 2.8l1.27.94a8 8 0 0 0-.21 1l-1.54.38a2 2 0 0 0-1.46 2.43l.48 1.94A2 2 0 0 0 8 21.32l1.52-.41a6.7 6 0 0 0 .68.8l-.67 1.46a2 2 0 0 0 1 2.65l1.82.83a2 2 0 0 0 2.65-1l.66-1.44h1.03l.71 1.41a2 2 0 0 0 2.69.88l1.79-.9a2 2 0 0 0 .88-2.69L22 21.5a6 6 0 0 0 .63-.83l1.56.32a2 2 0 0 0 2.36-1.55l.41-2a2 2 0 0 0-1.53-2.32M24.61 19l-1.56-.33a2 2 0 0 0-2.05.83 6 6 0 0 1-.49.64 2 2 0 0 0-.27 2.2l.76 1.47-1.78.9-1-2.05a1 1 0 0 0-1.07-.54 6 6 0 0 1-.95.11 7 7 0 0 1-1-.07 1 1 0 0 0-1 .58l-1 2.09-1.85-.83.65-1.45a2 2 0 0 0-.36-2.19 6 6 0 0 0-.52-.63A2 2 0 0 0 9.06 19l-1.55.39L7 17.43l1.55-.38a2 2 0 0 0 1.49-1.65 5 5 0 0 1 .16-.79 2 2 0 0 0-.72-2.09l-1.26-1L9.47 10l1.26 1a2 2 0 0 0 2.21.14 5 5 0 0 1 .72-.36 2 2 0 0 0 1.2-1.87V7.32h2v1.59a2 2 0 0 0 1.26 1.82 6 6 0 0 1 .74.33 2 2 0 0 0 2.21-.23l1.22-1 1.28 1.54-1.23 1a2 2 0 0 0-.63 2.12 5.4 5 0 0 1 .19.79 2 2 0 0 0 1.56 1.58l1.56.33z'></path>
                <path d='M15.92 12a4 4 0 0 0 .08 8h.08a4 4 0 0 0-.16-8M18 16a2 2 0 1 1-2-2 2 2 0 0 1 2 2'></path>
              </g>
            </svg>
          </button>
